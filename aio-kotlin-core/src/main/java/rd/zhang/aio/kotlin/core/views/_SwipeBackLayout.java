package rd.zhang.aio.kotlin.core.views;
...
/**
 * Created by Richard on 2017/8/28.
 */
public class _SwipeBackLayout extends FrameLayout {
    ...
    public _SwipeBackLayout(Context context) {
        this(context, null);
    }

    public _SwipeBackLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public _SwipeBackLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Context context) {
        ...
        mLeftShadow = getResources().getDrawable(R.drawable.swipe_left_shadow);
